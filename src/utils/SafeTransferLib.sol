        ...
        assembly {
            ...
            success :=
                and(
                    ...
                    // We use 100 because the length of our calldata totals up like
                    // so: 4 + 32 * 3.
                    // We use 0 and 32 to copy up to 32 bytes of return data into
                    // the scratch space.
                    // Counterintuitively, this call must be positioned second to
                    // the or() call in the
